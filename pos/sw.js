...
const PRECACHE_URLS = [
  ...
  '/assets/js/a33-firebase-config.js?v=4.20.77&r=7',
  '/assets/js/a33-firebase-core.js?v=4.20.77&r=8',
  '/assets/js/a33-firebase-auth.js?v=4.20.77&r=8',
  '/assets/js/a33-firebase-access.js?v=4.20.77&r=9',
  '/assets/js/a33-module-access.js?v=4.20.77&r=1',
